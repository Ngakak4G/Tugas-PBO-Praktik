...
cur.execute(
    "INSERT INTO `Gaji` VALUES ('Januari', '1829373890', 20, 0, 3, 1, 1, 60000)")
cur.execute(
    "INSERT INTO `Gaji` VALUES ('Februari', '1820282729', 20, 1, 1, 4, 2, 90000)")
cur.execute(
    "INSERT INTO `Gaji` VALUES ('Maret', '335456353', 23, 4, 0, 0, 2, 80000)")
db.commit()
...
cur.execute(
    "UPDATE Gaji SET masuk = 25, sakit = 1, ijin = 2 , alpha = 3 WHERE bulan= 'Januari'")
db.commit()
