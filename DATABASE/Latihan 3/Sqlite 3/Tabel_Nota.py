...
cur.execute("""
            INSERT INTO Nota VALUES ('001' ,date('now'), 'Senin', 5000000, 'SUP1');""")
cur.execute("""
            INSERT INTO Nota VALUES ('002' ,date('now'), 'Selasa',6000000, 'SUP2');""")
cur.execute("""
            INSERT INTO Nota VALUES ('003' ,date('now'), 'Rabu', 7000000, 'SUP3');""")
db.commit()
# # show nota (SELECT)
print("Data Nota")
