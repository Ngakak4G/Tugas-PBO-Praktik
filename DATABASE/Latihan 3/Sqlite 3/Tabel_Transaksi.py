...
cur.execute(
    "INSERT INTO Transaksi_Barang  VALUES ('001', 'A01', 1, 14000000);")
cur.execute(
    "INSERT INTO Transaksi_Barang  VALUES ('002', 'A02', 2, 15000000);")
cur.execute(
    "INSERT INTO Transaksi_Barang  VALUES ('003', 'A03', 3, 16000000);")
db.commit()
...
cur.execute(
    "UPDATE Transaksi_Barang SET Harga = 12000000 WHERE Kode_Barang = 'A01';")
db.commit()
