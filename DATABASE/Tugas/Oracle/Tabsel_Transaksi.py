...
# update transaksi
cur.execute("UPDATE Transaksi SET jumlah = 10000000 WHERE noTransaksi = 'trx01' AND idNasabah = 'PML01';")
db.commit()
# delete transaksi
cur.execute("DELETE FROM Transaksi WHERE noTransaksi = 'trx05' AND idNasabah = 'BDG01';")
db.commit()